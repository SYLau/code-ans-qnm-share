...
!            ,st='old',po='append')
            ...
            !======================================================================================================================================
            solve_full_gr: block
                use eigen_ld_aniso_mod,only:scan_Ain_c,get_ld_var,pul_sol
                ...
                if (option == '1') then
                    ...
                    call scan_Ain_c(ell,f1,f2,fi1,fi2,n,plt_f,plt_y) !Calculate amplitude of ingoing wave as function of Re(f) (Hz) to estimate the position of the mode
